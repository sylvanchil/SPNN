...
class DataUtil:
	...
	def toInputData(self, data, window,outputSize):
		dataList =[]
	...
	def trainAndTestSet(self,inputData,testSize):
	...
	def LSTMtrainAndTestSet(self,inputData,testSize):
